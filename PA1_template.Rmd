...
We should check the other column
...
### now lets comare the results to the first section

Calculate new total setps per day
...
```{r}
hi<-hist(istepsPerDay$TotalSteps,breaks=20)
...
plot(h,main ="With NA removed")
plot(hi, main ="Imputed")

```

Beacuse we added steps we get a differnt histogram but we see the means and medians are the same.
